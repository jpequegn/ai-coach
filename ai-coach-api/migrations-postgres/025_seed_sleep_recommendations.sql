-- Migration: Seed Sleep Optimization Recommendations
...
COMMENT ON TABLE recommendation_templates IS 'Sleep optimization recommendations seeded with 20 evidence-based interventions';
